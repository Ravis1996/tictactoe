 ...
 * @author ravisingh
 */
public class TicTacTeo_s extends javax.swing.JFrame {
    ...
    private void gameScore()
    {
        ...
        jblplyero.setText(String.valueOf(oCount));
    ...
    private void initComponents() {
        ...
        jblplyero = new javax.swing.JLabel();
        ...
        jblplayerx.setFont(new java.awt.Font("Lucida Grande", 1, 48)); // NOI18N
        jblplayerx.setText("jLabel3");
        ...
        jblplyero.setFont(new java.awt.Font("Lucida Grande", 1, 48)); // NOI18N
        jblplyero.setText("jLabel5");
        jPanel12.add(jblplyero, java.awt.BorderLayout.CENTER);
   ...
   if(startgame.equalsIgnoreCase("X"))
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(TicTacTeo_s.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new TicTacTeo_s().setVisible(true);
            }
        });
    }
    ...
    private javax.swing.JLabel jblplyero;
